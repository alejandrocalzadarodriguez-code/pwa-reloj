function actualizarHora() {                     // Declara la función que actualizará la hora en pantalla
    const reloj = document.getElementById("reloj"); // Obtiene el elemento con id "reloj" del DOM
    ...
    reloj.textContent = `${hh}:${mm}:${ss}`;  // Inserta la hora formateada dentro del elemento #reloj
}                                             // Fin de la función
